...
abstract class Vehicule {
  ...
  abstract void arretDemanderSortie(Passager p);
    ...
    /**
     * Convertit le conteneur de Passager de la classe concrete en
     * ArrayList de Passager, quelquesoit la nature du conteneur d'origine  
     */    

     abstract void allerArretSuivant(Vehicule v);
}
